...
def weather_advice():
    # Your control flow logic goes here
    cold = input("it is cold outside? (yes/no) ").lower()
    print(f'The user entered {cold}') 
    raining = input("it is raining outside? (yes/no) ").lower()
    print(f'The user entered {raining}')
    ...
    if cold == "yes" and raining == "yes":
        ...
        print("Please enter a valid answers")   
...
def determine_season():
    # Your control flow logic goes here
    while True:
        month = input("Enter the month of the year as three characters (Jan - Dec): ").lower()
